...
function SearchField({ value, onChange }: Props) {
  return (
    <div className="group">
      <label className="flex items-center gap-2 px-3.5 py-2.5 w-full max-w-[320px] min-w-[220px] border border-gray-300 group-focus-within:border-primary rounded-lg duration-300 avg:w-[320px]">
